          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Don't let legal challenges threaten your success. Partner with Sterling & Associates 
                for comprehensive legal protection and strategic guidance tailored to your business needs.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">No Upfront Fees</h3>
              <p className="text-sm text-muted-foreground">
                Free consultation with transparent pricing structure
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Attorney-client privilege and complete confidentiality
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Decades of experience with measurable outcomes
              </p>
            </div>
          </div>
        </div>
